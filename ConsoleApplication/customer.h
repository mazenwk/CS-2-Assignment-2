...
public:
	 ...
	 * \return Whether or not the target Customer's appointment is after this Customer's appointment
	 */
	 ...
	 * \param customer The Target Customer to compare with.
	 * \return Whether or not the target Customer's appointment is before this Customer's appointment
	 */
	bool operator > (const customer& customer) const;
	 ...
	 * \param customer The Target Customer to compare with.
	 * \return Whether or not the target Customer's appointment is equal to this Customer's appointment
	 */
	bool operator == (const customer& customer) const;
};
